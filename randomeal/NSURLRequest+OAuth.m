...
static NSString * const kConsumerKey       = @"cMC83MTrtvLfZl5cIIMqyw";
static NSString * const kConsumerSecret    = @"cay67Y9Tjqr-FhAgxsM2BIyHszI";
static NSString * const kToken             = @"BQt6iuyfjQTBvTDE7YV57jYCVPfne1v5";
static NSString * const kTokenSecret       = @"DYEqvHrVgOOrarUTunfGNv8qiiw";
